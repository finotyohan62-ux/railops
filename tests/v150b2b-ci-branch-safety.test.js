...
const forbiddenMutations = [
  ...
  { label: 'GitHub CLI pull-request mutation', pattern: /^\s*gh\s+pr\s+(?:merge|close|edit|review)\b/im },
  { label: 'GitHub CLI issue mutation', pattern: /^\s*gh\s+issue\s+(?:create|close|edit|reopen|comment)\b/im },
  { label: 'GitHub API write method', pattern: /^\s*gh\s+api\b[^\n]*(?:--method|-X)\s+(?:POST|PUT|PATCH|DELETE)\b/im },
  { label: 'curl write method', pattern: /^\s*curl\b[^\n]*(?:--request|-X)\s*(?:POST|PUT|PATCH|DELETE)\b/im },
