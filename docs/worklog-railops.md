...
- Vérification : le document est lisible depuis la branche après commit et reprend uniquement l’état observé via Supabase Advisor ; aucun fichier applicatif, test métier ou configuration de production modifié.
- Commit de changement : `68d56fcd74be1595edd7146458eb9da81fa34684` (`docs: capture Supabase advisor baseline`).
